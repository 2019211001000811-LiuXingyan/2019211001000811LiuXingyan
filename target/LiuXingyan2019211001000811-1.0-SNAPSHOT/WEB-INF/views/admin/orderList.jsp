			...
			<table class="table table-condensed">
				...
				<c:forEach var="0" items="${orderList}">
					<tr>
						<td>OID:${o.orderId}</td>
						<td>${o.orderDate}</td>
						<%com.LiuXingyan.model.Order o=(com.LiuXingyan.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiuXingyan.dao.UserDao userDao=new com.LiuXingyan.dao.UserDao();
						...
						<%	int n=o.getPaymentId();
							String paymentType=com.LiuXingyan.model.Payment.findByPaymentId(con,n);
